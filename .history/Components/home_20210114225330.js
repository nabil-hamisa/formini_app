...
import { FlatListm,Card, Image, ImageBackground, StyleSheet, Text, TouchableOpacity, View } from "react-native";
   ...
   const Courses = ({ item }) => {
    ...
    <Card containerStyle={styles.card}>
        ...
        <View style={styles.itemCategory}>
          ...
          <Text style={styles.itemText2}>Center Name: {item.name_co}</Text>
